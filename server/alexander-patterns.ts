...
export const alexanderPatterns: AlexanderPattern[] = [
  ...
  // Add remaining key patterns to complete the 253 collection
  {
    number: 111,
    name: "Half Hidden Garden",
    description: "If a garden is completely hidden from the house, people will not use it.",
    fullDescription: "If a garden is completely hidden from the house, people will not use it. But if it is entirely visible from the house, then there will be no magic in it. Therefore, put in a garden which is partially hidden from the main house, and partially visible. The house should partially enclose the garden, so that the garden is both private and connected to the house.",
    category: "Landscape",
    keywords: ["garden", "hidden", "visible", "magic", "private"],
    iconName: "trees",
    moodColor: "mysterious",
    relatedPatterns: [106, 114, 171, 173, 176]
  },
  {
    number: 124,
    name: "Activity Pockets",
    description: "Every public space needs activity around its edge.",
    fullDescription: "Every public space needs activity around its edge. Therefore, surround public gathering places with pockets of activity - nooks, small gardens, steps, changes in level, trees, seats, outdoor cafes, kiosks - so that people can choose different levels of engagement with the social life around them.",
    category: "Public Space",
    keywords: ["activity", "pockets", "edge", "engagement", "choice"],
    iconName: "zap",
    moodColor: "dynamic",
    relatedPatterns: [61, 69, 88, 100, 241]
  },
  {
    number: 129,
    name: "Common Areas at the Heart",
    description: "No social group - whether a family, a work group, or a school group - can survive without constant informal contact among its members.",
    fullDescription: "No social group - whether a family, a work group, or a school group - can survive without constant informal contact among its members. Therefore, create a single common area for every social group. Locate it at the center of gravity of all the spaces the group occupies, and in such a way that the paths which go in and out of the building lie tangent to it.",
    category: "Interior",
    keywords: ["common", "heart", "social", "contact", "center"],
    iconName: "heart",
    moodColor: "central",
    relatedPatterns: [76, 98, 142, 147, 183]
  },
  {
    number: 131,
    name: "The Flow Through Rooms",
    description: "The movement between rooms is as important as the rooms themselves.",
    fullDescription: "The movement between rooms is as important as the rooms themselves; and its arrangement has fundamental effects on social interaction. Therefore, as far as possible, avoid the use of corridors and passages. Instead, use a layout of rooms which connects them one to the next, so that from each room there is a view into at least one other room.",
    category: "Interior",
    keywords: ["flow", "rooms", "movement", "connection", "view"],
    iconName: "arrow-right",
    moodColor: "flowing",
    relatedPatterns: [98, 129, 132, 159, 225]
  },
  {
    number: 142,
    name: "Sequence of Sitting Spaces",
    description: "Every corner of a building, and every space along a path, must be given careful attention to make sure that each of them creates a pleasant place to sit.",
    fullDescription: "Every corner of a building, and every space along a path, must be given careful attention to make sure that each of them creates a pleasant place to sit. Therefore, put in a sequence of graded sitting spaces throughout the building and around it. Some should be private, some public, some indoor, some outdoor, some high, some low.",
    category: "Interior",
    keywords: ["sitting", "spaces", "sequence", "graded", "pleasant"],
    iconName: "armchair",
    moodColor: "comfortable",
    relatedPatterns: [129, 131, 180, 185, 241]
  },
  {
    number: 147,
    name: "Common Meal",
    description: "A common meal is perhaps the most fundamental of all social institutions.",
    fullDescription: "A common meal is perhaps the fundamental social institution. Therefore, wherever there is a group of people sharing common land, arrange the kitchen and eating space to make it possible for them to take their meals together. Specifically, place the common kitchen and eating space at the heart of the common land.",
    category: "Social",
    keywords: ["meal", "common", "social", "kitchen", "together"],
    iconName: "utensils",
    moodColor: "communal",
    relatedPatterns: [75, 80, 129, 139, 183]
  },
  {
    number: 156,
    name: "Settled Work",
    description: "You cannot work well if your workspace is too enclosed, or too exposed.",
    fullDescription: "You cannot work well if your workspace is too enclosed, or too exposed. A good workspace strikes the balance. Therefore, avoid extremes of enclosure. Do not build extremely enclosed work places, and do not build extremely open ones. Make workspaces partially enclosed, so that people can choose the amount of enclosure they want by where they place themselves.",
    category: "Work",
    keywords: ["settled", "work", "balance", "enclosure", "choice"],
    iconName: "briefcase",
    moodColor: "balanced",
    relatedPatterns: [40, 80, 83, 85, 86]
  },
  {
    number: 165,
    name: "Opening to the Street",
    description: "A building gives a person dignity just to the extent that it has a front door which belongs clearly to that person, and opens directly onto the street.",
    fullDescription: "A building gives a person dignity just to the extent that it has a front door which belongs clearly to that person, and opens directly onto the street. Therefore, whenever possible, give each person and each family a recognizable piece of land, with a front door opening directly off a public pedestrian path, not more than 150 feet from the road.",
    category: "Housing",
    keywords: ["opening", "street", "dignity", "front", "door"],
    iconName: "door-open",
    moodColor: "dignified",
    relatedPatterns: [31, 55, 89, 110, 120]
  },
  {
    number: 171,
    name: "Tree Places",
    description: "Trees have a more profound influence on human action and feeling than most people realize.",
    fullDescription: "Trees have a more profound influence on human action and feeling than most people realize. Therefore, work with the trees on the site to create a variety of spaces - some in the sun, some in the shade of trees. Use the trees to create outdoor rooms, and to mark special places.",
    category: "Landscape",
    keywords: ["trees", "places", "influence", "shade", "rooms"],
    iconName: "tree-pine",
    moodColor: "natural",
    relatedPatterns: [51, 60, 64, 67, 74]
  },
  {
    number: 172,
    name: "Garden Growing Wild",
    description: "A garden which is too highly controlled is lifeless.",
    fullDescription: "A garden which is too highly controlled is lifeless. Therefore, grow grasses, flowers, trees, and bushes in a way which comes close to the way they grow wild: intermingled, without barriers between them, without bare earth, without hard edges.",
    category: "Landscape",
    keywords: ["garden", "wild", "natural", "intermingled", "organic"],
    iconName: "flower",
    moodColor: "wild",
    relatedPatterns: [64, 81, 87, 93, 111]
  },
  {
    number: 173,
    name: "Garden Wall",
    description: "Gardens and small public spaces don't give the right feeling unless they are properly enclosed.",
    fullDescription: "Gardens and small public spaces don't give the right feeling unless they are properly enclosed. Therefore, form some kind of enclosure around every garden and every public outdoor space. The enclosure need not be a wall; it can be a building, a hedge, a fence, a change in level.",
    category: "Landscape",
    keywords: ["garden", "wall", "enclosure", "proper", "boundary"],
    iconName: "fence",
    moodColor: "enclosed",
    relatedPatterns: [97, 106, 111, 172, 243]
  },
  {
    number: 183,
    name: "Workspace Enclosure",
    description: "People cannot work effectively if their workspace is entirely enclosed or entirely open.",
    fullDescription: "People cannot work effectively if their workspace is entirely enclosed or entirely open. Therefore, arrange each workspace as a partial enclosure around one or two sides of a desk, so that there is an 'inside' which is sheltered and an 'outside' which is more exposed.",
    category: "Work",
    keywords: ["workspace", "enclosure", "partial", "sheltered", "exposed"],
    iconName: "square-dashed",
    moodColor: "balanced",
    relatedPatterns: [41, 80, 147, 156, 179]
  },
  {
    number: 194,
    name: "Interior Windows",
    description: "People are by nature gregarious.",
    fullDescription: "People are by nature gregarious. They like to see what other people are doing. Therefore, put in windows between rooms, so that people can see from one space into another, and begin to feel the presence of the people in the spaces around them.",
    category: "Interior",
    keywords: ["interior", "windows", "gregarious", "connection", "presence"],
    iconName: "square",
    moodColor: "connected",
    relatedPatterns: [107, 131, 159, 180, 225]
  },
  {
    number: 225,
    name: "Frames as Thickened Edges",
    description: "Any homogeneous membrane which has holes in it will weaken the membrane as a whole.",
    fullDescription: "Any homogeneous membrane which has holes in it will weaken the membrane as a whole, unless the edges of the holes are reinforced by thickening. Therefore, make window frames, door frames, and picture frames as thick, deep, substantial elements which form the edges around openings.",
    category: "Construction",
    keywords: ["frames", "thickened", "edges", "reinforced", "substantial"],
    iconName: "square",
    moodColor: "substantial",
    relatedPatterns: [53, 102, 107, 110, 194]
  },
  {
    number: 241,
    name: "Seat Spots",
    description: "Where outdoor seats are set down thoughtlessly, they are never used.",
    fullDescription: "Where outdoor seats are set down thoughtlessly, they are never used. Therefore, choose each seat carefully, according to the place it's in, the view from it, its relationship to paths, and the amount of enclosure around it.",
    category: "Outdoor",
    keywords: ["seat", "spots", "thoughtful", "view", "relationship"],
    iconName: "armchair",
    moodColor: "thoughtful",
    relatedPatterns: [92, 93, 94, 124, 142]
  },
  {
    number: 249,
    name: "Ornament",
    description: "A building needs ornament, but there is very little ornament being made today.",
    fullDescription: "A building needs ornament, but there is very little ornament being made today. Therefore, carve the beam ends, the window frames, the eaves, make patterns in the path, the garden gate, shutters; build canvas awnings, window boxes; put tiles around the door. All of these will help make the building and the life in it more cheerful.",
    category: "Details",
    keywords: ["ornament", "decoration", "patterns", "cheerful", "details"],
    iconName: "sparkles",
    moodColor: "decorative",
    relatedPatterns: [70, 225, 250, 251, 252]
  },
  {
    number: 250,
    name: "Warm Colors",
    description: "The colors in a room strongly influence the comfort and well-being of the people in it.",
    fullDescription: "The colors in a room strongly influence the comfort and well-being of the people in it. Therefore, choose surface colors which are warm to the touch and warm in feeling. Specifically, reds, browns, oranges, yellows, rather than blues, greens, grays, and whites.",
    category: "Details",
    keywords: ["warm", "colors", "comfort", "feeling", "surface"],
    iconName: "palette",
    moodColor: "warm",
    relatedPatterns: [180, 249, 251, 252, 253]
  },
  {
    number: 251,
    name: "Different Chairs",
    description: "People are different sizes; they also sit and relax in different ways.",
    fullDescription: "People are different sizes; they also sit and relax in different ways. Therefore, never choose a single type of chair for a public space; always provide a variety of different kinds of chairs, some big, some small, some soft, some hard, some rockers, some very easy to move around.",
    category: "Furniture",
    keywords: ["different", "chairs", "variety", "sizes", "comfort"],
    iconName: "armchair",
    moodColor: "varied",
    relatedPatterns: [142, 241, 249, 250, 252]
  },
  {
    number: 252,
    name: "Pools of Light",
    description: "Uniform illumination - the sweetheart of the lighting engineers - serves no useful purpose whatsoever.",
    fullDescription: "Uniform illumination - the sweetheart of the lighting engineers - serves no useful purpose whatsoever. What people need, to feel comfortable in a room, is the interplay of light and dark around the room, with pool of light to draw people together. Therefore, place sources of light around the room to form individual pools: table lamps, standard lamps, spotlights, not overhead fluorescent lighting or any form of uniform lighting.",
    category: "Light",
    keywords: ["pools", "light", "interplay", "comfortable", "individual"],
    iconName: "lightbulb",
    moodColor: "intimate",
    relatedPatterns: [159, 180, 249, 250, 251]
  },
  {
    number: 96,
